<p align="center">
  <img src="images/logo.png" alt="Lammergeier Lang" width="240">
</p>
...
<p align="center">
  ...
  <a href="docs/stdlib.md">Stdlib</a> ·
  <a href="docs/installation.md">Install</a> ·
  <a href="docs/package_manager.md">Package manager</a> ·
  <a href="docs/TRANSPILATION.md">Transpilation</a> ·
...
See [`docs/SYNTAX.md`](docs/SYNTAX.md) for the complete language reference, and
[`docs/TRANSPILATION.md`](docs/TRANSPILATION.md) for the authoritative Lam → Go
...
verifying the install, uninstalling): [`docs/installation.md`](docs/installation.md).
...
[`tools/registry/`](tools/registry/) as a Docker image:
...
[`docs/package_manager.md`](docs/package_manager.md).
**Authoring a library** (manifest format, scoped names, registry
protocol): [`docs/third_party_libraries.md`](docs/third_party_libraries.md).
...
The static site under [`website/`](website) renders the same docs
...
[`website/README.md`](website/README.md) for deployment notes.

## Standard library

The stdlib lives in [`lib/`](lib) and is imported exactly like any user
module:
...
- A **comprehensive reference** for every stdlib module — classes,
  methods, examples — lives in [`docs/stdlib.md`](docs/stdlib.md).
- A **plugin-authoring guide** for the `lamserver` HTTP toolkit
  ...
  [`docs/server_plugins.md`](docs/server_plugins.md).
- A one-line-per-module inventory is in the
  [Standard Library section of `docs/SYNTAX.md`](docs/SYNTAX.md#standard-library).
...
LSP client** lives in
[`vs-code-extension/`](vs-code-extension/lammergeier-lang/README.md).
