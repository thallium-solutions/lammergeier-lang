...
> `take` / `takeWhile`) reach for the [`lamiter`](#/docs/stdlib?h=lamiter)
...
exposes as static methods. See [TRANSPILATION.md](#/docs/transpilation)
...
[`lamiter` stdlib module](#/docs/stdlib?h=lamiter) (`Iter.fromList(xs)
