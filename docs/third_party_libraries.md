...
> gate) see [`docs/package_manager.md`](package_manager.md).
...
[`docs/package_manager.md`](package_manager.md) instead if you
...
[`tools/registry/`](../tools/registry/) and ships as both a
...
**[`docs/package_manager.md`](package_manager.md)**. That doc covers:
...
[`docs/package_manager.md`](package_manager.md#6-the-semver--api-diff-gate).
